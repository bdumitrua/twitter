	...
	return (
		<div className={styles["profile"]}>
			...
			<div className={styles["profile__bar"]}>
				...
				<div
					className={styles["profile__biography"]}
				>
					Digital Goodies Team - Web & Mobile
					UI/UX development; Graphics;
					Illustrations
				</div>
				<div
					className={
						styles["profile__additional-data"]
					}
				>
					<div
						className={
							styles["profile__link-block"]
						}
					>
					...
					<div
						className={
							styles["profile__date-block"]
						}
					>
						<img src={calendarIcon} alt="" />
						<span
							className={
								styles["profile__date"]
							}
						>
				...
				<div
					className={styles["profile__counters"]}
				>
					<div
						className={
							styles["profile__counter"]
						}
					>
						<span
							className={
								styles[
									"profile__counter-number"
								]
							}
						>
							216
			...
			<div className={styles["profile__tabs"]}></div>
		</div>
	);
};
