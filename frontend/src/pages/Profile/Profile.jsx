...
const Profile = () => {
	return (
		<div className={styles["profile"]}>
			<img className={styles["profile__banner"]} src={banner} alt="" />
			<div className={styles["profile__bar"]}>
				...
				<div className={styles["profile__user-data"]}>
					<div className={styles["profile__username"]}>Pixsellz</div>
					<div className={styles["profile__nickname"]}>@pixsellz</div>
				</div>
				...
				<div className={styles["profile__counters"]}>
					<div className={styles["profile__counter"]}>
						<span className={styles["profile__counter-number"]}>
							216
						</span>
						<span className={styles["profile__counter-text"]}>
							Following
						</span>
					</div>
					<div className={styles["profile__counter"]}>
